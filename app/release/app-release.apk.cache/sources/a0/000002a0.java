...
public class o000000 extends ImageButton {

    /* renamed from: OooO00o  reason: collision with root package name */
    public final o00Oo0 f2262OooO00o;

    /* renamed from: OooO0O0  reason: collision with root package name */
    public final o000000O f2263OooO0O0;

    /* renamed from: OooO0OO  reason: collision with root package name */
    public boolean f2264OooO0OO;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public o000000(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        o0O0o000.OooO00o(context);
        this.f2264OooO0OO = false;
        oo0OOoo.OooO00o(this, getContext());
        o00Oo0 o00oo0 = new o00Oo0(this);
        this.f2262OooO00o = o00oo0;
        o00oo0.OooO0o0(attributeSet, i);
        o000000O o000000o2 = new o000000O(this);
        this.f2263OooO0O0 = o000000o2;
    ...
    public final void drawableStateChanged() {
        ...
        o00Oo0 o00oo0 = this.f2262OooO00o;
        if (o00oo0 != null) {
            o00oo0.OooO00o();
        }
        o000000O o000000o2 = this.f2263OooO0O0;
        if (o000000o2 != null) {
            o000000o2.OooO00o();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if ((!(((ImageView) this.f2263OooO0O0.f2266OooO0O0).getBackground() instanceof RippleDrawable)) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        o000000O o000000o2 = this.f2263OooO0O0;
        if (o000000o2 != null && drawable != null && !this.f2264OooO0OO) {
            o000000o2.f2265OooO00o = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (o000000o2 != null) {
            o000000o2.OooO00o();
            if (!this.f2264OooO0OO) {
    ...
    public void setImageLevel(int i) {
        ...
        this.f2264OooO0OO = true;
    }

    @Override // android.widget.ImageView
    public void setImageResource(int i) {
        this.f2263OooO0O0.OooO0OO(i);
    }
